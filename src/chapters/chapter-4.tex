...
\begin{table}[ht]
    ...
    \begin{tabular}{| c | c | c | c |}
        ...
        \hline
    \end{tabular}
    \caption{Tabel Data Lamanya Jawaban Berada Dalam Antrian Sistem Pada Saat Pengujian UGrade}
...
\begin{table}[ht]
    ...
    \begin{tabular}{| c | c | c | c |}
        ...
        \hline
    \end{tabular}
    \caption{Tabel Data Lamanya Jawaban Dinilai Oleh Sistem Pada Saat Pengujian UGrade}
...
\begin{table}[ht]
    ...
    \end{tabular}
    \caption{Tabel Data Lamanya Jawaban Berada Dalam Sistem Pada Saat Pengujian UGrade}
...
\begin{figure}[ht!]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Diagram Jumlah Jawaban Pada Antrian UGrade}
    \label{fig:ugrade-queue}
\end{figure}

\par Pengujian UGrade dilakukan dengan beberapa nilai \textit{grading size}. Nilai \textit{grading size} yang diuji adalah satu, dua dan lima. Untuk meningkatkan keakuratan pengujian, setiap nilai \textit{grading size} diuji sebanyak tiga kali. Tabel \ref{tab:ugrade-wait-time}, \ref{tab:ugrade-process-time} dan \ref{tab:ugrade-system-time} memaparkan data hasil pengujian kinerja sistem \textit{online judge} UGrade. Gambar \ref{fig:ugrade-queue} manggambarkan jumlah jawaban yang berada pada antrian sistem UGrade dari waktu ke waktu.
